...
for layer_id, layer in enumerate(settings.FEATURE_NAMES):
    ...
    dt_features, true_images, feature_names = activate_experiment.activate_exp_places365(images_365, true_index, places365_features[layer_id], thresholds, rendered_order)
