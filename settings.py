...
AddImgFileName = True                                        # add according image file name in HTML
PLACES365_VAL_DIRECTORY = 'dataset/val_256'
PLACES365_VAL_SIZE = 224
PLACES365_VAL_OUTPUT_FOLDER = 'result/places365_exp_result'

# resnet18_places365_layer1 is stored in res/(symbolic link), or Seagate/res
########### sub settings ###########
